...
export const EXPLORE_STYLES = {
  ...
  filterWrapper: 'flex flex-col max-w-screen md:flex-row md:justify-between md:items-center gap-4 mb-12 pb-2',
  ...
  flex: 'flex flex-col space-x-2 md:flex-row md:overflow-scroll',
  card: {
    wrapper: 'group relative bg-white rounded-3xl overflow-hidden shadow-2xl transition-all duration-300 cursor-pointer',
    thumbnail: 'relative overflow-hidden bg-green-500 h-90 lg:w-full',
